...
<head>
    ...
    .tag-checkbox:checked {
        background-color:rgb(4, 4, 41); /* Couleur de fond lorsque coché */
       /* Bordure lorsque coché */
    }
    ...
    /* Ajout d'une petite marge à gauche de la checkbox pour la séparation */
    .checkbox-item .tag-checkbox {
        margin-left: 5px;
    }
                            ...
                            <div style="overflow-y: scroll;  height:100px ">
                                ...
                                ?>
                                    <div class="checkbox-item">
                                        <input type="checkbox" name="tags[]" style="" value="<?php echo htmlspecialchars($tag['tag_id']); ?>" id="tag_<?php echo $tag['tag_id']; ?>" class="tag-checkbox">
